...
{{-- Виводимо шаблон з схемою автобуса --}}
...
{{--                     $wire.setSelectedSeat('{{ $seat['number'] }}', '{{ $seat['price'] }}');--}}
{{--                     @this.call('setSelectedSeat', '{{ $seat['number'] }}', '{{ $seat['price'] }}');--}}
{{--                 }"--}}
...
{{-- Додаємо Livewire компонент --}}
{{--<livewire:seat-selector />--}}
